...
const initCommdityListView = {
	list: [],
	capacity: 10,
	marginTop: 0,
	index: 0
}
const commdityListView = (commdityListView = initCommdityListView, action) => {
	switch(action.type){
		case 'updateCommdityListViewList':
			return Object.assign({}, commdityListView, {list: action.payload})
		case 'updateCommdityListViewMarginTop':
			return Object.assign({}, commdityListView, {marginTop: action.payload})
		case 'updateCommdityListViewIndex':
			return Object.assign({}, commdityListView, {index: action.payload})
		default: 
			return commdityListView
	} 
}
...
const initCommSelectArea = {
	province: {},
	city: {},
	distinct: {}
}
const commSelectArea = (commSelectArea = initCommSelectArea, action) => {
	switch(action.type){
		case 'commSelectProvince':
			return Object.assign({}, commSelectArea, {province: action.payload});
		case 'commSelectCity':
			return Object.assign({}, commSelectArea, {city: action.payload});
