...
class TagContainerProxy {
    ...
    getByTagName(tagName){
        ...
        return Object.keys(this.container).filter(k => this.container[k].root.localName === tagName)[0];
    }
}
...
const compareAndUpate = arr => {
    let refinedComponents = distinct(Array.from(flat(arr)), c => c.root.localName);
